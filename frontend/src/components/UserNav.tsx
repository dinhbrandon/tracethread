...
const UserNav = () => {
  ...
  <div className="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden">
    <div className="flex items-center py-4">
      ...
      <ol className="ml-3 flex items-center whitespace-nowrap min-w-0" aria-label="Breadcrumb">
        <li><a href="http://localhost:3000" className="flex items-center text-sm text-gray-800 ">
          Tracethread
        ...
        <li><a href="http://localhost:3000" className="text-sm font-semibold text-gray-800 truncate" aria-current="page">
          Home
        </a></li>
      </ol>
      {/* <!-- End Breadcrumb --> */}
  ...
  {/* <!-- Sidebar --> */}
  <div id="application-sidebar" className="h-full hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden  top-0 left-0 bottom-0 md:z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
    <div className="px-6">
    ...
    <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul className="space-y-1.5">
        <li>
          <a className="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-md hover:bg-gray-100" href="http://localhost:3000">
